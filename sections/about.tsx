    ...
    <section className="px-4 my-10 md:my-14 lg:my-20">
      <div className="max-w-screen-md lg:max-w-[1150px] mx-auto flex flex-col lg:flex-row gap-y-6 gap-x-6">
        <div className="w-full lg:w-1/2">
          ...
          <p className='text-lg md:text-[19px] xl:text-[21px] xl:leading-9 mt-4'><strong>Professional Accounting Group is an accounting firm based in Kosovo providing accounting, tax, and advisory services to business owners and their families.</strong></p>
