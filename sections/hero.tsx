  ...
  return (
    <section className="hero-bg h-[75vh] flex items-center px-4">
      <div className="max-w-screen-lg mx-auto w-full">
        <h1 className='text-white text-[26px] md:text-4xl md:text-center lg:text-left lg:text-5xl font-bold lg:leading-[65px]'>Professional <span>Accounting</span> <br />  & Tax services</h1>
